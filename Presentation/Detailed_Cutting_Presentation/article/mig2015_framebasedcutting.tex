...
\usepackage[export]{adjustbox} % add valign=<t,m,b> option to \usepackage{microtype} % subtly better typography
...
{%
    \renewcommand{\@oddhead}{\hfil\textit{\large ACM SIGGRAPH Motion in Games 2015}\hfil}%
...
%
  \textsf{
    \vfill\vfill\textbf{From the proceedings of Motion in Games 2015.}\vfill
...
\title{Interactive Detailed Cutting of Thin Sheets}
\author
{
    Pierre-Luc Manteaux$^{1}$ \hspace{0.35cm} Wei-Lun Sun$^{2}$ \hspace{0.35cm} Fran\c cois Faure$^{1}$ \hspace{0.35cm} Marie-Paule Cani$^{1}$ \hspace{0.35cm} James F. O'Brien$^{2}$
    \vspace{0.25cm} \\
    $^{1}$University Grenoble-Alpes, CNRS (LJK) and Inria
    \thanks{$\left\lbrace\right.$pierre-luc.manteaux$\vert$fran\c cois.faure$\vert$marie-paule.cani$\left.\right\rbrace$@inria.fr}
    \hspace{0.35cm} 
    $^{2}$University of California, Berkeley
    \thanks{$\left\lbrace\right.$sunweilunjwilson$\vert$job$\left.\right\rbrace$@berkeley.edu}
}
\pdfauthor{Pierre-Luc Manteaux}
...
\includegraphics[width=\linewidth]{images/Spiral2.pdf}
\caption{\label{fig:spiral}}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.45\linewidth}
\includegraphics[width=\linewidth]{images/Kirigami.pdf}
...
\centering
\includegraphics[width=\linewidth]{images/spiral_mesh.pdf}
\caption{\label{fig:spiralMesh}}
\end{subfigure}
\hspace{1.5cm}
\begin{subfigure}[c]{0.70\linewidth}
\centering
\includegraphics[width=\linewidth]{images/sfRender_ff/weightShow.pdf}
...
\centering
\includegraphics[width=\linewidth]{images/buildSF_1.pdf}
\caption{\label{fig:buildSF1}}
\end{subfigure}
\hspace{2cm}
\begin{subfigure}[b]{0.20\linewidth}
\centering
\includegraphics[width=\linewidth]{images/buildSF_2.pdf}
\caption{\label{fig:buildSF2}}
\end{subfigure}
\hspace{2cm}
\begin{subfigure}[b]{0.20\linewidth}
\centering
\includegraphics[width=\linewidth]{images/buildSF_3.pdf}
...
\begin{subfigure}[b]{0.20\linewidth}
\centering
\includegraphics[width=\linewidth]{images/connectivity.pdf}
\caption{\label{fig:connectivity}}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.30\linewidth}
\centering
\includegraphics[width=\linewidth]{images/simple_cut.pdf}
\caption{\label{fig:simplecut}}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.40\linewidth}
\centering
\includegraphics[width=\linewidth]{images/little_pieces.pdf}
\caption{\label{fig:littlePieces}}
\end{subfigure}
%\hfill
%\begin{subfigure}[b]{0.24\linewidth}
%\centering
%\includegraphics[width=\linewidth]{images/multi_cut.pdf}
...
\begin{subfigure}[b]{0.20\linewidth}
\centering
\includegraphics[width=\linewidth]{images/buildNMG_1.pdf}
\caption{\label{fig:buildNMG1}}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.20\linewidth}
\centering
\includegraphics[width=\linewidth]{images/buildNMG_2.pdf}
\caption{\label{fig:buildNMG2}}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.20\linewidth}
\centering
\includegraphics[width=\linewidth]{images/buildNMG_3.pdf}
\caption{\label{fig:buildNMG3}}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.20\linewidth}
\centering
\includegraphics[width=\linewidth]{images/buildNMG_4.pdf}
...
\centering
\includegraphics[width=\linewidth]{images/Patchwork.pdf}
\caption{\label{fig:patchwork}}
\end{subfigure}
\hfill
\begin{subfigure}[c]{0.33\linewidth}
\centering
\includegraphics[width=\linewidth]{images/FallingGuy.pdf}
\caption{\label{fig:fallingguy}}
\end{subfigure}
\hfill
\begin{subfigure}[c]{0.33\linewidth}
\centering
\includegraphics[width=\linewidth]{images/Vortex.pdf}
...
This work was partially funded by the advanced grant no. 291184 EXPRESSIVE from the European Research Council (ERC-2011-ADG$\_$20110209) and the France Berkeley Fundation.

%\begin{itemize}
%    \item Fabrice (Kirigami)
%    \item Léo Allemand-Giorgis (CGAL)
%	\item Ulysse (Discussion)
%	\item Julio (Dijkstra)
%\end{itemize}
...
\bibliography{mig2015_framebasedcutting}
...
\centering
\includegraphics[height=2.2cm]{images/remeshing_1.pdf}
\caption{\label{fig:remeshing1}}
\end{subfigure}
\hfill
\begin{subfigure}[c]{0.3\linewidth}
\centering
\includegraphics[height=2.2cm]{images/remeshing_2.pdf}
\caption{\label{fig:remeshing2}}
\end{subfigure}
\hfill
\begin{subfigure}[c]{0.3\linewidth}
\centering
\includegraphics[height=2.2cm]{images/remeshing_3.pdf}
...
\begin{subfigure}[c]{0.3\linewidth}
\centering
\includegraphics[height=2.2cm]{images/basic_mesh.pdf}
\caption{\label{fig:basicMesh}}
\end{subfigure}
\hfill
\begin{subfigure}[c]{0.3\linewidth}
\centering
\includegraphics[height=2.2cm]{images/edge_split.pdf}
\caption{\label{fig:edgeSplitting}}
\end{subfigure}
\hfill
\begin{subfigure}[c]{0.3\linewidth}
\centering
\includegraphics[height=2.2cm]{images/vertex_insertion.pdf}
...
\begin{subfigure}[c]{0.3\linewidth}
\centering
\includegraphics[height=2.2cm]{images/vertex_splitting_1.pdf}
\caption{\label{fig:vertexSplitting1}}
\end{subfigure}
\begin{subfigure}[c]{0.3\linewidth}
\centering
\includegraphics[height=2.2cm]{images/vertex_splitting_2.pdf}
\caption{\label{fig:vertexSplitting2}}
\end{subfigure}
\begin{subfigure}[c]{0.3\linewidth}
\centering
\includegraphics[height=2.2cm]{images/vertex_splitting_3.pdf}
