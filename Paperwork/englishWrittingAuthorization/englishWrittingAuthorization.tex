...
\Large\hspace{0.5cm} \hfill ~\\[0.05in] % First line of institution name, adjust hspace if your logo is wide
...
~\\[-0.2cm] % Reduce the whitespace above the horizontal rule
\hspace{4.2cm}\vhrulefill{1pt} \\ % Horizontal rule, adjust hspace if your logo is wide and \vhrulefill for the thickness of the rule
\hspace{\fill}\parbox[t]{9cm}{ % Create a box for your details underneath the horizontal rule on the right
