...
\Jury{
%\UGTPresidente{}{}
\UGTPresidente{Joëlle Thollot}{Professeur, Université de Grenoble}
...
\UGTExaminatrice{Florence Zara}{Maître de conférences, LIRIS}     %% 1er examinateur
\UGTExaminateur{Paul G. Kry}{Maître de conférences, McGill University}     %% second examinateur

\UGTDirecteur{Fran\c cois Faure}{Professeur, Université Joseph Fourier}       %% Directeur de thèse
\UGTCoDirecteur{Marie-Paule Cani}{Professeur, Université de Grenoble}     %% Co-Directeur de thèse s'il y en a
