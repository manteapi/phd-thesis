...
In the next chapter, we address this problem by proposing a novel method to sculpt animations of liquids using intuitive tools inspired from shape modeling.
