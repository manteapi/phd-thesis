...
\Lettrine{C}{ombining} efficiency with visual realism had been one of the main goals of computer graphics research in the last decade. 
In Section~\ref{chap:starAdaptivity}, we presented adaptive models, a general strategy to concentrate the computational time on the most interesting parts of an animated scene. 
...
Therefore, transition thresholds based on visibility or distance to camera would certainly allow to even more focus the computational power where it most contributes to the quality of the result.
\paragraph*{}
