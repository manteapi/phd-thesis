...
\centering
\includegraphics[scale=1.0]{images/starAdaptivity-cgf2016/freezing-rigid.png}
\caption{\label{fig:stackFreezing}}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.45\linewidth}
\centering
\includegraphics[scale=1.0, angle=0]{images/starAdaptivity-cgf2016/freezing-graph.png}
