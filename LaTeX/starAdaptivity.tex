...
\paragraph*{}
This section was published in \emph{Computer Graphics Forum, 2016}~\cite{Manteaux2016}.
\begin{figure}[!h]
	\centering
...
This made possible to interactively run large scale simulations and to resolve complex behaviors which require a very fine scale.
